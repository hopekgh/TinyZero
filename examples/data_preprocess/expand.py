...
User: {problem} Show your work in <think> </think> tags. And return the final answer in <answer> </answer> tags, for example <answer>230</answer>.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_size', type=int, default=18000)
    ...
    raw_dataset = load_dataset('HanyangMed/polynomial_problems', split='train')
